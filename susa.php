...
<?php
   ...
   <div class="slide-one-item home-slider owl-carousel">
      ...
      <div class="site-blocks-cover overlay"
        style="background-image: url(<?= $daxili1['sekil1'] ?>); background-size: 100% 120%;" data-aos="fade"
      ...
      <div class="site-blocks-cover overlay"
        style="background-image: url(<?= $daxili1['sekil2'] ?>);background-size: 100% 120%;" data-aos="fade"
        data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
      ...
      <div class="site-blocks-cover overlay"
        style="background-image: url(<?= $daxili1['sekil3'] ?>);background-size: 100% 120%;" data-aos="fade"
        data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
    ...
    <div class="site-section border-top">
      <div class="container">
        <div class="row text-center">
          <div class="col-md-12">
            <h2 class="mb-5 text-black">Bizimlə Şuşaya səyahət etmək istəyirsiniz?</h2>
