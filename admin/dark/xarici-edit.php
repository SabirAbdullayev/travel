...
require_once "nav.php"; require_once "../settings/code/xarici.php"; require_once 'tinymce.php'; ?>
<!-- ============================================================== -->
<!-- Page wrapper  -->
<!-- ============================================================== -->
                ...
                <div class="card">
                    <div class="card-body">
                        <form id="formid" class="mt-4" method="POST" action="#" enctype="multipart/form-data">
                            ...
                            <button type="submit" class="btn btn-primary" name="xarici_edit">Redaktə Et</button>
                        </form>
                    </div>
                </div>
            </div>
